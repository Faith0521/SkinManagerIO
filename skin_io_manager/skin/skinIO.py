...
def exportSkin(folderPath, objs, versioning=False, file_ext='.npz'):
...
def importSkin(folderPath, objs=[], createMissingJoints=False, skipAlreadySkinned=True, file_ext='.npz'):
    if not os.path.exists(folderPath):
